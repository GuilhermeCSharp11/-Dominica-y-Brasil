...
DiscordLib.Notification = function(self, text, text2, delays, logo)
    ...
    Main_UiStroke.Color = Color3.fromRGB(0, 0, 139)
    ...
    imagenoti.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
    ...
    LableFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
    ...
    TextNoti.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
    TextNoti.BackgroundTransparency = 1
    TextNoti.Size = UDim2.new(0, 175, 0, 25)
    TextNoti.Font = Enum.Font.Code
    TextNoti.Text = text2
    TextNoti.TextColor3 = Color3.fromRGB(0, 0, 139)
    ...
    Time.Active = true
    Time.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
...
local function SaveKey(key)
    if writefile then
        writefile("Brasilnica_Key.txt", key)
    end
end

local function LoadSavedKey()
    if isfile and readfile then
        if isfile("Brasilnica_Key.txt") then
            return readfile("Brasilnica_Key.txt")
        end
    end
    return nil
end
...
local function IsKeyValid(key)
    return key == "Brasilnica_FREEHS62BEU746"
end
...
if not keyValid then
    ...
    WindowStroke.Color = Color3.fromRGB(0, 0, 139)
    ...
    DISCORD.Position = UDim2.new(0.13418974, 0, 0.6, 0)
    DISCORD.Size = UDim2.new(0, 140, 0, 40)
    DISCORD.Font = Enum.Font.SourceSans
    DISCORD.Text = "DISCORD"
    DISCORD.TextColor3 = Color3.fromRGB(0, 0, 139)
    DISCORD.TextSize = 14
    
    DISCORD.MouseButton1Click:Connect(function()
        if setclipboard then
            setclipboard("https://discord.gg/u5kNqGT9y")
        end
    ...
    WindowStrokeshit2.Color = Color3.fromRGB(0, 0, 139)
    ...
    WindowStrokeshit4.Color = Color3.fromRGB(0, 0, 139)
    ...
    SUBMIT.Text = "Brasilnica"
    SUBMIT.TextColor3 = Color3.fromRGB(0, 0, 139)
    SUBMIT.TextSize = 14
    ...
    WindowStroke2.Color = Color3.fromRGB(0, 0, 139)
    ...
    WindowStrokeshit.Color = Color3.fromRGB(0, 0, 139)
    ...
    LOGO.Name = "LOGO"
    LOGO.Parent = Main
    LOGO.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
    LOGO.BackgroundTransparency = 1
    LOGO.Position = UDim2.new(-0.0470297076, 0, 0.0708536655, 0)
    LOGO.Size = UDim2.new(0, 216, 0, 199)
    LOGO.Image = "rbxassetid://SEU_ID_AQUI" -- Coloque o ID da imagem KFSA.jpg aqui
    ...
    KEYHERE.Text = ""
    KEYHERE.TextColor3 = Color3.fromRGB(0, 0, 139)
    KEYHERE.TextSize = 14
    ...
    GETKEY.Name = "GET KEY"
    GETKEY.Parent = Main
    GETKEY.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
    ...
    GETKEY.TextColor3 = Color3.fromRGB(0, 0, 139)
    GETKEY.TextSize = 14
    ...
    SUBMIT2.Name = "SUBMIT"
    SUBMIT2.Parent = Main
    SUBMIT2.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
    ...
    SUBMIT2.TextColor3 = Color3.fromRGB(0, 0, 139)
    SUBMIT2.TextSize = 14
    ...
    DISCORD2.BackgroundColor3 = Color3.fromRGB(8, 8, 8)
    ...
    DISCORD2.TextColor3 = Color3.fromRGB(0, 0, 139)
    ...
    NAME2.Name = "NAME"
    NAME2.Parent = Main
    NAME2.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
    ...
    NAME2.Text = "Brasilnica       KEY SYSTEM"
    NAME2.TextColor3 = Color3.fromRGB(0, 0, 139)
    NAME2.TextSize = 16

    HUB2.Name = "HUB"
    HUB2.Parent = Main
    HUB2.BackgroundColor3 = Color3.fromRGB(0, 0, 139)
    ...
    HUB2.Text = "   HUB"
    HUB2.TextColor3 = Color3.fromRGB(0, 0, 139)
    HUB2.TextSize = 16
